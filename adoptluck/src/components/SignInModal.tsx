          ...
          <form onSubmit={handleResolveUser} className="space-y-3" id="roblox-username-form">
            <div className="relative">
              <input
                ...
                autoComplete="off"
                autoFocus
                className="w-full px-4 py-3 rounded-xl bg-[#111728] border border-[#202c47] text-white placeholder-slate-500 text-sm focus:outline-none focus:border-[#00E701] transition-all font-medium"
              />
            </div>
            ...
            <button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-xl font-bold text-xs uppercase tracking-wider bg-[#00E701] hover:bg-[#00c901] text-[#090d16] transition-all shadow active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
            >
              {isLoading ? (
                <>
          ...
          <div className="space-y-4" id="roblox-profile-phrase-view">
            ...
            <div className="flex items-center justify-between p-3 bg-[#111827] border border-[#1f2d48] rounded-2xl">
              <div className="flex items-center gap-3">
                <img
                  ...
                  className="w-11 h-11 rounded-full border border-[#00E701]/40 object-cover bg-black shrink-0"
                />
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button
                  ...
                  className="text-[10px] text-slate-400 hover:text-[#00E701] flex items-center gap-1 cursor-pointer transition-colors"
                >
              ...
              <div className="flex items-center gap-2 p-2.5 bg-[#070b14] border border-[#00E701]/40 rounded-xl">
                <div className="flex-1 font-mono font-bold text-[#00E701] text-xs sm:text-sm tracking-wide select-all px-1 break-all">
                  {phrase}
                </div>
                <button
                  id="copy-phrase-btn"
                  ...
                  className={`flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer shrink-0 ${
                    copied
                      ...
                      : 'bg-[#00E701] hover:bg-[#00c901] text-black shadow'
                  }`}
                >
                  {copied ? (
                    <>
            ...
            {isSuccess ? (
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-bold text-xs uppercase tracking-wider bg-[#00E701] hover:bg-[#00c901] text-[#090d16] transition-all shadow-md active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50 mt-1"
              >
                {isLoading ? (
                  <>
                    <RefreshCw className="w-3.5 h-3.5 animate-spin" />
